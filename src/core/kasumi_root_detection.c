...
static KASUMI_NOCFI bool kasumi_kp_scan_kernel_image(void)
{
...
static KASUMI_NOCFI bool kasumi_kp_scan_vmap_nodes(void)
{
...
static KASUMI_NOCFI bool kasumi_kp_scan_legacy_vmap_list(void)
{
